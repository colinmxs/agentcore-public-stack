...
- [ ] 1. Set up test infrastructure and shared fixtures
  - [ ] 1.1 Create backend test directories and conftest files
  ...
  - [ ] 1.2 Verify Hypothesis and fast-check are available
...
- [ ] 2. Remove legacy EntraIDJWTValidator
  - [ ] 2.1 Audit comments and remove legacy validator
  ...
  - [ ] 2.2 Verify no regression after removal
...
- [ ] 3. Checkpoint - Verify test infrastructure and legacy removal
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. GenericOIDCJWTValidator tests
  - [ ] 4.1 Audit JWT validator comments and write unit tests
...
- [ ] 5. FastAPI auth dependency tests
  - [ ] 5.1 Audit auth dependency comments and write unit tests
...
- [ ] 6. RBAC role checker tests
  - [ ] 6.1 Audit RBAC comments and write unit tests
...
- [ ] 7. Checkpoint - Verify auth layer tests
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 8. AppRoleService permission resolution tests
  - [ ] 8.1 Audit AppRoleService comments and write unit tests
...
- [ ] 9. AppRoleAdminService CRUD tests
  - [ ] 9.1 Audit AppRoleAdminService comments and write unit tests
...
- [ ] 10. AppRoleCache TTL and invalidation tests
  - [ ] 10.1 Audit AppRoleCache comments and write unit tests
...
- [ ] 11. Checkpoint - Verify RBAC layer tests
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 12. OIDC state store tests
  - [ ] 12.1 Audit state store comments and write unit tests
...
- [ ] 13. PKCE generation tests
  - [ ] 13.1 Audit PKCE comments and write unit tests
...
- [ ] 14. GenericOIDCAuthService flow tests
  - [ ] 14.1 Audit OIDC auth service comments and write unit tests
...
- [ ] 15. Auth routes integration tests
  - [ ] 15.1 Audit auth routes comments and write integration tests
...
- [ ] 16. Checkpoint - Verify all backend tests
...
- [ ] 17. Frontend AuthService tests
  - [ ] 17.1 Audit AuthService comments and write Vitest tests
...
- [ ] 18. Frontend auth guard and admin guard tests
  - [ ] 18.1 Audit guard comments and write Vitest tests
...
- [ ] 19. Frontend interceptor tests
  - [ ] 19.1 Audit interceptor comments and write Vitest tests
...
- [ ] 20. Checkpoint - Verify all frontend tests
...
- [ ] 21. Backend property-based tests (Hypothesis)
  - [ ] 21.1 Create backend PBT file with Hypothesis strategies
...
- [ ] 22. Frontend property-based tests (fast-check)
  - [ ] 22.1 Create frontend PBT file with fast-check arbitraries
...
- [ ] 23. Final checkpoint - Full test suite verification
