...
Apply these patterns when working with Angular components, services, templates, or any frontend development in this project.
...
For complex derived state patterns, see #[[file:angular-signal-patterns.md]]
...
const userName = computed(() => 
  userResource.hasValue() ? userResource.value().name : undefined
);
```
