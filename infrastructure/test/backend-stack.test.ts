...
describe('BackendStack', () => {
  ...
  describe('RAG Ingestion Lambda', () => {
    it('creates the ingestion Lambda function', () => {
      ...
      // Three Lambda functions in BackendStack:
      //   1. RAG ingestion (DockerImageFunction)
      //   2. Artifact render (Function)
      //   3. CFN custom-resource handler (S3 bucket notification
      //      configurator, auto-injected by CDK when addEventNotification
      //      is wired from an imported bucket)
  ...
  describe('Artifact Render Lambda', () => {
    it('publishes the auto-generated render function name to SSM', () => {
      template.hasResourceProperties('AWS::SSM::Parameter', {
