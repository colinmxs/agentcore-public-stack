...
log_info "Running CDK synth for ${CDK_PROJECT_PREFIX}-GatewayStack..."
...
eval "cdk synth ${CDK_PROJECT_PREFIX}-GatewayStack ${CONTEXT_PARAMS}" || {
    log_error "CDK synth failed for ${CDK_PROJECT_PREFIX}-GatewayStack"
    exit 1
}
