...
# Description: Runs Python tests for the Inference API service using uv
...
main() {
    ...
    uv run python -c "import fastapi; import uvicorn; import strands; print('✓ Core dependencies installed')"
